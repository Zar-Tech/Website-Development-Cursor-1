export const games = [
  ...
  },
  {
    ...
    tagline: 'Dodge enemies, collect gems, stay alive.',
    description:
      'Move fast, dodge incoming hazards, and collect diamonds to keep your energy up. Survive as long as you can and unlock new character looks as your score climbs.',
    image: '/games/dodge-and-survive-card.jpg',
    images: {
      icon: '/games/dodge-and-survive-icon.png',
      hero: '/games/dodge-and-survive-hero.jpg',
      card: '/games/dodge-and-survive-card.jpg',
      tile: '/games/dodge-and-survive-tile.jpg',
      panel: '/games/dodge-and-survive-panel.jpg',
    },
    rating: 92.8,
    players: '2,956',
    genre: 'Arcade',
  ...
  },
  {
    id: 6,
    title: 'Void Hunter',
    tagline: 'Hunt through the void — survive the unknown.',
    description:
      'Pilot into deep space and hunt targets across hostile sectors. Upgrade your gear, outmaneuver enemies, and push deeper into the void with every run.',
    image: '/games/void-hunter-card.jpg',
    images: {
      icon: '/games/void-hunter-icon.png',
      hero: '/games/void-hunter-hero.jpg',
      card: '/games/void-hunter-card.jpg',
      tile: '/games/void-hunter-tile.jpg',
      panel: '/games/void-hunter-panel.jpg',
    },
    rating: 90.2,
    players: '4,508',
    genre: 'Action',
